...
def xgbregressor_gbtree_hyperparameters_search(X, y, gpu_available, ticker_symbol):
...
def xgbregressor_gbtree_resume_training(X, y, gpu_available, ticker_symbol, hyperparameter_search=False, delete_old_data=False):
...
def xgbregressor_gbtree_predict(X, ticker_symbol, no = 1):
