...
Model_Type = "xgbregressor_gbtree"


def xgbregressor_gbtree_hyperparameters_search(X, y, gpu_available, ticker_symbol, pca):
    ...
    def xgbregressor_gbtree_objective(trial):
        param = {
            'verbosity': 0,
...
def xgbregressor_gbtree_resume_training(X, y, gpu_available, ticker_symbol, pca=False, hyperparameter_search=False,
    ...
    if hyperparameter_search_needed:
        xgbregressor_gbtree_hyperparameters_search(X, y, gpu_available, ticker_symbol, pca)
...
def xgbregressor_gbtree_predict(X, ticker_symbol, pca=False, no=1):
