...
def xbclassifier_hyperparameters_search(X, y, gpu_available, ticker_symbol):
    ...
    study.optimize(xbclassifier_objective, n_trials=100)
...
def xbclassifier_predict(X, ticker_symbol , no = 1):
