...
def conv1d_regression_hyperparameters_search(X, y, gpu_available, ticker_symbol):
    ...
    study.optimize(conv1d_regression_objective,  n_trials=100)
...
def conv1d_regression_resume_training(X, y, gpu_available, ticker_symbol, hyperparameter_search=False,
